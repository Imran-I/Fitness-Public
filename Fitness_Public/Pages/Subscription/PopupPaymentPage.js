...
if (divupi != null) {
    ...
    if (sessionStorage.getItem("PaymentAfterSubBookingId") != null) {
        document.getElementById('verifyandpay').value = "Resend SMS";
        let NotificationData = {};
        NotificationData = {
            queryType: "SendSMSforbookingsubscription",
            ...
            link: 'https://prematix.com/fitness/Pages/upi/upi.aspx?Plan=S&BookingId=' + sessionStorage.getItem("PaymentAfterSubBookingId")
        };
                ...
                if (data.StatusCode === 0) {
                    ...
                    if (sessionStorage.getItem("Bookingby") == 'QR') {
                        if (sessionStorage.getItem("PaymentAfterSubBookingId") != null) {
                            ...
                            //var qrdatas = 'https://paypre.in/upi.aspx?BookingId=' + sessionStorage.getItem("PaymentAfterSubBookingId");
                            //var qrdatas = 'https://prematix.com/fitness/Pages/upi/upi.aspx?Plan=S&BookingId=' + sessionStorage.getItem("PaymentAfterSubBookingId");
                    ...
                    if (sessionStorage.getItem("Bookingby") == 'QR') {
                        ...
                        const arr = str.split("~");
                        sessionStorage.setItem("PaymentAfterSubBookingId", arr[0])
                        document.getElementById("hfBookingId").value = sessionStorage.getItem("PaymentAfterSubBookingId");
                        var qrdatas = 'https://prematix.com/fitness/Pages/upi/upi.aspx?Plan=S&BookingId=' + sessionStorage.getItem("PaymentAfterSubBookingId");
                        new QRCode(document.getElementById(`qrcode`), {
                            text: `${qrdatas}`,
                            width: 128,
    ...
    function BookingPaymentstatus() {
        var FormData = 'BookingId='+ sessionStorage.getItem("PaymentAfterSubBookingId");
